...
<div class="pvc-calculator-wrapper" id="pvc-calculator">
    ...
    <div class="pvc-progress">
        ...
        <div class="pvc-progress-step" data-step="4">
            <span class="step-number">4</span>
            <span class="step-label">Vēršanās</span>
        </div>
        ...
        <div class="pvc-progress-step" data-step="6">
            ...
            <span class="step-label">Krāsa ārā</span>
        </div>
        <div class="pvc-progress-step" data-step="7">
            <span class="step-number">7</span>
            <span class="step-label">Krāsa iekšā</span>
        </div>
        <div class="pvc-progress-step" data-step="8">
            <span class="step-number">8</span>
            <span class="step-label">Stiklojums</span>
        </div>
        <div class="pvc-progress-step" data-step="9">
            <span class="step-number">9</span>
            <span class="step-label">Rokturi</span>
        </div>
    ...
    <div class="pvc-calculator-content">
        ...
        <!-- Step 4: Vēršanās veids / Bīdīšanās veids -->
        <div class="pvc-step" data-step="4">
            <div class="pvc-step-header">
                <h2 class="pvc-step-title pvc-opening-title">4. Vēršanās veids</h2>
                <p class="pvc-step-description">Izvēlieties atvēršanās veidu.</p>
            </div>
            <div class="pvc-options-grid pvc-options-4 pvc-opening-types">
                <!-- Opening types will be generated by JS based on product and division type -->
            </div>
        </div>
        ...
        <div class="pvc-step" data-step="5">
            <div class="pvc-step-header">
                <h2 class="pvc-step-title">5. Izmēri</h2>
        ...
        <!-- Step 6: Krāsa no ārpuses -->
        <div class="pvc-step" data-step="6">
            <div class="pvc-step-header">
                <h2 class="pvc-step-title">6. Krāsa no ārpuses</h2>
                <p class="pvc-step-description">Izvēlieties krāsu no āra puses.</p>
            </div>
        ...
        <div class="pvc-step" data-step="7">
            ...
            <div class="pvc-same-color-option">
        ...
        <!-- Step 9: Rokturi -->
        <div class="pvc-step" data-step="9">
            <div class="pvc-step-header">
                <h2 class="pvc-step-title">9. Rokturi</h2>
                <p class="pvc-step-description">Izvēlieties roktura veidu.</p>
            </div>
            <div class="pvc-options-grid pvc-options-4 pvc-handle-options">
                <div class="pvc-option pvc-handle-option" data-value="standart-balts">
                    <div class="pvc-option-image">
                        <svg viewBox="0 0 60 100" class="pvc-icon">
                            <rect x="25" y="20" width="10" height="60" rx="3" fill="#fff" stroke="#666" stroke-width="2"/>
                            <circle cx="30" cy="75" r="8" fill="#fff" stroke="#666" stroke-width="2"/>
                        </svg>
                    </div>
                    <span class="pvc-option-label">Standarta balts</span>
                </div>
                <div class="pvc-option pvc-handle-option" data-value="standart-antracits">
                    <div class="pvc-option-image">
                        <svg viewBox="0 0 60 100" class="pvc-icon">
                            <rect x="25" y="20" width="10" height="60" rx="3" fill="#3d3d3d" stroke="#222" stroke-width="2"/>
                            <circle cx="30" cy="75" r="8" fill="#3d3d3d" stroke="#222" stroke-width="2"/>
                        </svg>
                    </div>
                    <span class="pvc-option-label">Standarta antracīts</span>
                </div>
                <div class="pvc-option pvc-handle-option" data-value="premium-hroms">
                    <div class="pvc-option-image">
                        <svg viewBox="0 0 60 100" class="pvc-icon">
                            <defs>
                            ...
                            <rect x="25" y="20" width="10" height="60" rx="3" fill="url(#chrome-grad)" stroke="#999" stroke-width="2"/>
                            <circle cx="30" cy="75" r="8" fill="url(#chrome-grad)" stroke="#999" stroke-width="2"/>
                        </svg>
                    </div>
                    <span class="pvc-option-label">Premium hroms</span>
                </div>
                <div class="pvc-option pvc-handle-option" data-value="premium-zelts">
                    <div class="pvc-option-image">
                        <svg viewBox="0 0 60 100" class="pvc-icon">
                            <defs>
                            ...
                            <rect x="25" y="20" width="10" height="60" rx="3" fill="url(#gold-grad)" stroke="#8b6914" stroke-width="2"/>
                            <circle cx="30" cy="75" r="8" fill="url(#gold-grad)" stroke="#8b6914" stroke-width="2"/>
                        </svg>
                    </div>
                    <span class="pvc-option-label">Premium zeltains</span>
                </div>
            </div>
        </div>
        ...
        <div class="pvc-step" data-step="10">
            <div class="pvc-step-header">
                <h2 class="pvc-step-title">10. Kontaktinformācija</h2>
